...
\caption{PDR plot for various spreading factors. (r = 3000 m, GW = 1, ${R_{b}}$ = 0.01 pps)}
\label{fig:sf}
\end{figure}
...
\caption{PDR plot for various network radii. (GW = 1, SF = SF{\_}Lowest, ${R_{b}}$ = 0.01 pps)}
\label{fig:r}
\end{figure}
...
\caption{PDR plot for various number of gateways. (r = 3000 m, SF = SF{\_}Lowest, ${R_{b}}$ = 0.01 pps)}
\label{fig:gw}
\end{figure}
...
\caption{PDR  plot for lowest and smart spreading factor schemes. (r = 5000 m, GW = 3, ${R_{b}}$ = 0.01)}
